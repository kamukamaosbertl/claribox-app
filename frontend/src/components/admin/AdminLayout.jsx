...
const getFeedbackCategory = (item) =>
  item?.topicLabel || item?.topicShortLabel || item?.category || 'Uncategorized';
            ...
            <div style={{ flex: 1, maxWidth: 520, position: 'relative' }} ref={searchRef}>
              <div style={{ position: 'relative' }}>
                ...
                <input
                  ...
                  placeholder="Search feedback, categories, tags, ID..."
                  style={{
                    width: '100%',
                ...
                <div style={{
                  ...
                  {searchLoading ? (
                    <div className="px-[14px] py-6 text-center">
                      <p className="text-[12.5px] text-[#94A3B8] m-0">Searching...</p>
                    </div>
                    ...
                    <>
                      {searchResults.map((item) => {
                        ...
                        return (
                          ...
                          >
                            <span className="shrink-0 text-[10.5px] font-bold text-[#2563EB] bg-[#EFF6FF] border border-[#DBEAFE] rounded-[20px] px-2 py-[2px] mt-[1px] max-w-[150px] overflow-hidden text-ellipsis whitespace-nowrap">
                              {categoryName}
                            </span>

                            <div className="flex-1 min-w-0">
                              <p className="text-[12.5px] text-[#334155] m-0 overflow-hidden text-ellipsis whitespace-nowrap">
                                {item.feedback}
                              </p>

                              <p className="text-[10.5px] text-[#94A3B8] m-0 mt-[3px] overflow-hidden text-ellipsis whitespace-nowrap">
                                {item.anonymous_id}
                    ...
                    <div className="px-[14px] py-6 text-center">
                      <p className="text-[12.5px] text-[#94A3B8] m-0">
                        No feedback found for "{searchQuery}"
                      </p>
                    </div>
                  )}
                </div>
                          ...
                          >
                            ...
                            <div onClick={() => handleNotifClick(notif)} style={{ flex: 1, minWidth: 0, cursor: 'pointer' }}>
                              <p style={{
                                ...
                                color: !notif.isRead ? '#0F172A' : '#334155',
                                margin: '0 0 3px',
                                lineHeight: 1.3,
                    ...
                    <div style={{
                      ...
                      <div style={{ position: 'relative', display: 'flex', alignItems: 'center', gap: 12 }}>
                        <div style={{ position: 'relative' }}>
                          ...
                          <label className="absolute inset-0 rounded-[13px] bg-black/45 flex items-center justify-center opacity-0 hover:opacity-100 cursor-pointer transition-opacity duration-150">
                            {uploading ? (
